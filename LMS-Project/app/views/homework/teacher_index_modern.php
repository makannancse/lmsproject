    ...
    <div class="col-12">
        <div class="card shadow-sm mb-1">
            <div class="card-body py-2">
                <form method="get" action="<?= h($base . '/teacher/homework') ?>" class="row g-2 align-items-end no-app-loader">
                    ...
                    <div class="col-12 col-md-auto ms-auto d-flex gap-2">
                        ...
                        <a href="<?= h($base . '/teacher/homework') ?>" class="btn btn-sm btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
